...
This shell does not supply native USB/serial, GPS, background audio, file upload or guaranteed speech synthesis support. The Web Serial Port client may be unavailable in Android WebView. ESP32 access still needs a native USB bridge or compatible network bridge; neither is implemented in this shell. Do not treat this as finished vehicle integration.
