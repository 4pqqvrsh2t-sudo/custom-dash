...
if(typeof window!=='undefined'){
 ...
 window.radarTone=(kind,test=false)=>{try{if(document.hidden||!enabled&&!test)return;if(window.CustomSounds?.play('radar-'+kind))return;const c=audioContext();if(c.state!=='running')return;const o=c.createOscillator(),g=c.createGain(),t=c.currentTime;o.type='sine';o.frequency.setValueAtTime(kind==='arrival'?260:200,t);o.frequency.exponentialRampToValueAtTime(kind==='arrival'?390:120,t+.12);g.gain.setValueAtTime(.0001,t);g.gain.exponentialRampToValueAtTime(Math.max(.0002,.08*prefs.volume/100),t+.01);g.gain.exponentialRampToValueAtTime(.0001,t+.14);o.connect(g);g.connect(c.destination);o.start(t);o.stop(t+.15);}catch{}};
}
