...
assert.equal(g.model(120).secondaryMax,53.6448);assert.equal(g.model(120,'km/s').secondaryMax,.0536448);
assert.equal(g.model(60).mphFraction,.5);assert.equal(g.model(0).mphFraction,0);assert.equal(g.model(120).mphFraction,1);
assert.equal(g.model(60).secondaryFraction,.5);assert.equal(g.model(60,'km/s').secondaryFraction,.5);
