...
const SpeedGauge = (()=>{
  ...
  function model(mph,unit='m/s'){
    ...
    if(!valid)return {valid:false,speed:null,mphFraction:0,secondary:null,secondaryMax:MAX_MPH*MPH_TO_METERS_PER_SECOND/(unit==='km/s'?1000:1),secondaryFraction:0};
